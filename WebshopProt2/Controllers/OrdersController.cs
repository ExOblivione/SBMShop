...
namespace WebshopProt2.Controllers
{
    public class OrdersController : Controller
    {
        ...
        public async Task<ActionResult> Create([Bind(Include = "OrderId,OrderDate,Username,FirstName,LastName,Address,City,PostalCode,Country,Phone,Experation,SaveInfo,Email,Total")] Order order)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<ActionResult> Edit([Bind(Include = "OrderId,OrderDate,Username,FirstName,LastName,Address,City,PostalCode,Country,Phone,Experation,SaveInfo,Email,Total")] Order order)
        {
            if (ModelState.IsValid)
            {
